...
type Book struct {
	...
	Price         *Price                 `protobuf:"bytes,2,opt,name=price,proto3" json:"price,omitempty"`   // 引用price.proto
	Author        *author.Info           `protobuf:"bytes,3,opt,name=author,proto3" json:"author,omitempty"` // 导入其他目录下的author
...
const file_book_book_proto_rawDesc = "" +
	...
	"\x04data\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\x04data23\n" +
	"\vBookService\x12$\n" +
	"\n" +
	"CreateBook\x12\n" +
	".book.Book\x1a\n" +
