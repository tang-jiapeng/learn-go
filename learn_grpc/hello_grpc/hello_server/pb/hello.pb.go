...
func (x *AddParam) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AddParam) ProtoMessage() {}

func (x *AddParam) ProtoReflect() protoreflect.Message {
	mi := &file_pb_hello_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AddParam.ProtoReflect.Descriptor instead.
func (*AddParam) Descriptor() ([]byte, []int) {
	return file_pb_hello_proto_rawDescGZIP(), []int{2}
}

func (x *AddParam) GetX() int32 {
	if x != nil {
		return x.X
	}
	return 0
...
const file_pb_hello_proto_rawDesc = "" +
	...
	"\tBidiHello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x00(\x010\x01B\x11Z\x0fhello_server/pbb\x06proto3"
